...
export const ZUserPerferConfigKey = z.union([
  ...
  z.literal('isShowTextCount'),
  z.literal('isCountPunctuation'),
  z.literal('isOrderByCreateTime'),
  z.literal('language'),
  z.literal('theme'),
  z.literal('webhookEndpoint'),
  z.literal('webhookEventFilter'),
...
export const ZConfigSchema = z.object({
  ...
  isShowTextCount: z.boolean().optional(),
  isCountPunctuation: z.boolean().optional(),
  ...
  webhookEventFilter: z.array(z.string()).optional(),
